            ...
            <div class="section" id="list-product-wp">
                ...
                <div class="section-detail">
                    ...
                    if (isset($_POST['s'])) {
                        ...
                        $sql_count = "SELECT COUNT(*) AS total_rows FROM `product` WHERE productName LIKE '%$keyword%'";
                        ...
                        $sql = "SELECT * FROM `product` WHERE productName LIKE '%$keyword%' LIMIT $start, $num_per_page";
                    ...
                    ?>
                                <li>
                                    ...
                                    <div class="action clearfix">
                                        ...
                                        <?php } else { ?>
                                            <a title="Hết hàng" class="disabled" style="background-color: red;">Hết hàng</a>
                                        <?php } ?>
                                    </div>
                                </li>
                    <?php
                            ...
                            if ($num_pages > 1) {
                                ...
                                for ($i = 1; $i <= $num_pages; $i++) {
                                    echo '<a href="?trang=' . $i . '&s=' . $keyword . '" class="page-link">' . $i . '</a> ';
                                }
                                echo '</nav>';
                            }
                        } else {
