...
$sql = "SELECT COUNT(*) AS user_count FROM users WHERE userTypeID = 1";
                ...
                <div class="section-detail">
                    <div class="filter-wp clearfix">
                        <ul class="post-status fl-left">
                            <li class="all"><a href="">Tất cả <span class="count">(<?php echo $userCount ?>)</span></a></li>
                        </ul>
    ...
    padding: 20px; background-color: white; border: none;">
                    ...
                    <div class="table-responsive">
                        <table class="table list-table-wp">
                            ...
                            <tbody>
                                <?php
                                $sql_list_user = "SELECT * FROM `users` WHERE `userTypeID`='1' ORDER BY `isTime` DESC";
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="tbody-thumb">
                                                    <img src="/project/Web_banHang.com/myPham.com/<?php echo trim($item['user_avater']); ?>" alt="">    
                                                </div>
                                            </td>
                                            ...
                                            <td><a href="?page=profile_user&id=<?php echo $item['userID'] ?>">
